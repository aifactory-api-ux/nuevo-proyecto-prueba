...
pip install pytest pytest-cov pytest-asyncio httpx anyio fastapi sqlalchemy pydantic python-multipart -q 2>/dev/null || true
...
export ASYNC_DATABASE_URL="sqlite:///:memory:"
